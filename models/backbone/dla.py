...
model_urls = {
    'dla34': 'https://github.com/yjh0410/YOWOF/releases/download/yowof-weight/dla34_coco.pth',
}
...
def dla34(pretrained=False):
    model = DLA34()

    if pretrained:
        print('Load pretrained weight {} for backbone'.format(model_urls["dla34"]))
...
if __name__ == '__main__':
    ...
    # build resnet
    model, feat_dim = build_dla('dla34', pretrained=True)
